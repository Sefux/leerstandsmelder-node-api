...
module.exports.sendConfirmationRequest = function (user) {
    return sendMail({
        ...
        lang: 'en',
        substitutions: [
            {key: '!CONFIRM_URL!', value: 'http://www.leerstandsmelder.de/confirm/' + user.single_access_token}
        ]
    });
};
...
module.exports.sendResetPassword = function (user) {
    return sendMail({
        ...
        lang: 'en',
        substitutions: [
            {key: '!RESET_URL!', value: 'http://www.leerstandsmelder.de/reset/' + user.single_access_token}
        ]
    });
};